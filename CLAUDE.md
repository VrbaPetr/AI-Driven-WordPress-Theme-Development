...
├── acf-json/                    # ACF Local JSON — auto-saved by the ACF admin UI, never edited manually
...
- **ACF fields via admin UI, not code** — definitions saved as Local JSON to `acf-json/` and version-controlled.
